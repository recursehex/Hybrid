...
ref int b = a
b = 2
// Both a and b should be 2 (linked)

// Test 2: Regular variable vs ref variable (no linking)
int x = 10
int y = x
y = 20
// x should still be 10, y should be 20

// Test 3: Ref variable linking
ref int x2 = 10
ref int y2 = x2
y2 = 20
// Both x2 and y2 should be 20 (linked)

// Test 4: Regular variable with ref linking
int num1 = 100
int num2 = ref num1
num2 = 200
// Both num1 and num2 should be 200 (linked)
...
// val1 should be 10, val2 should be 5
...
int copy = linked
// copy should be 42 (value copied, not linked)